...
const Footer = () => {
    return (
        <footer className="bg-[#6265da] shadow-dark-mild text-gray-300 py-6">
           <Container>
               <div className="container mx-auto px-4">
                   <div className="flex flex-col md:flex-row justify-between mb-4">
                       {/* Logo or Company Name */}
                       <div className="text-center md:text-left mb-4 md:mb-0">
                           <h1 className="text-xl font-bold text-white">ICT Tower</h1>
                       ...
                       <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-8">
                           <div className="flex flex-col space-y-1">
                               ...
                               <a href="/sitemap" className="hover:text-gray-400 text-sm">Sitemap</a>
                               <a href="/privacy-policy" className="hover:text-gray-400 text-sm">Privacy Policy</a>
                               <a href="/contact" className="hover:text-gray-400 text-sm">Contact</a>
                               <a href="/faq" className="hover:text-gray-400 text-sm">FAQ</a>
                               <a href="/terms" className="hover:text-gray-400 text-sm">Terms of Use</a>
                           </div>

                           <div className="flex flex-col space-y-1">
                               <h3 className="text-base font-semibold text-white">Contact Us</h3>
                               <p className="text-sm">Email: <a href="mailto:info@example.com" className="hover:text-gray-400">info@example.com</a></p>
                               <p className="text-sm">Phone: <a href="tel:+1234567890" className="hover:text-gray-400">+123 456 7890</a></p>
                           </div>
                       </div>
                   </div>
