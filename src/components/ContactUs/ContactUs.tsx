          ...
          <div className="flex flex-wrap">
            <div className="mb-12 w-full md:w-full lg:w-5/12 lg:px-6">
              <form>
                ...
                <button
                  type="button"
                  className="mb-6 w-full rounded bg-purple-500 text-white px-6 py-2.5 text-xs font-medium uppercase"
                >
                  Send
                </button>
              </form>
                ...
                <div className="mb-12 w-full md:w-6/12 xl:w-6/12">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <div className="inline-block rounded-full bg-purple-500 p-3 text-white shadow-md">
